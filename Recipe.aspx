<%@ Page Title="" Language="C#" MasterPageFile="~/User.Master" AutoEventWireup="true" CodeBehind="Recipe.aspx.cs" Inherits="FoodRecipePortal.Recipe" %>
    ...
    <section class="food_section layout_padding">
        <div class="container">
            ...
            <ul class="filters_menu">
                ...
                <li data-filter=".south">South Indian</li>
                <li data-filter=".north">North Indian</li>
                <li data-filter=".gujarati">Gujarati</li>
                <li data-filter=".rajasthani">Rajasthani</li>
            </ul>

            <div class="filters-content">
                <div class="row grid">
                    <div class="col-sm-6 col-lg-4 all italian">
                        <div class="box">
                            <div>
                                <div class="img-box">
                    ...
                    <div class="col-sm-6 col-lg-4 all chinese">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/friedrice.jpg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>Vegetable Fried Rice
                                    </h5>
                                    <p>
                    ...
                    <div class="col-sm-6 col-lg-4 all chinese">
                        <div class="box">
                            <div>
                                <div class="img-box">
                                    <img src="images/veghakka.jpg" alt="">
                                </div>
                                <div class="detail-box">
                                    <h5>Veg Hakka Noodles
                                    </h5>
                                    <p>
